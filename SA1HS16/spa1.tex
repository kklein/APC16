...
We plug this into the expected value of $Z_n$.
	\begin{align}
		\mathbb{E}[Z_n] &=\frac{1}{n-1} \sum_{k=1}^{n-1}\mathbb{E} [Z_n^{(k)}] \\
		&= \frac{1}{n-1} \sum_{k=1}^{n-1} ( 2  - \frac{1}{k+1} - \frac{1}{n-k+1}) \\
		&= \frac{1}{n-1} (2 -  \sum_{k=1}^{n-1} \frac{1}{k+1} -  \sum_{k=1}^{n-1}\frac{1}{n-k+1}) \\
		&= \frac{1}{n-1} (2 - \sum_{k=2}^{n} \frac{1}{k}  -  \sum_{k=2}^{n}\frac{1}{k}) \\
